...
public class HomeMutilpartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    switch (itemViewType) {
      case 0:
        itemView = View.inflate(context, R.layout.item_home, null);
        holder = new HomeViewHolder(itemView);
        break;
      case 1:
        itemView = View.inflate(context, R.layout.item_home_another, null);
        holder = new AnotherViewHolder(itemView);
        break;
    }
    return holder;
  }
  ...
  public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
    if (viewHolder instanceof HomeViewHolder) {
      ...
      homeViewHolder.tv_homeInfo.setText(beanList.get(position).getTitle());
      ...
      anotherViewHolder.tv_homeAnotherInfo.setText(beanList.get(position).getTitle());
    }
  }
